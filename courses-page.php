<?php /* Template Name: STIMAT - Courses Page */ ?>
...
<?php get_header( ); ?>
    ...
    <div class="little-hero" id="little-hero">
        ...
        <div class="little-hero-text">
            ...
            <h1 class="little-big-text text-center">Courses Offered At STIMAT</h1>
    ...
    <div class="container px-2 mt-lg-4 py-2 mt-md-3">

        <div class="row">

            <div class="px-2 py-4 col-lg-9 col-12 page-content-text">
